...
\centering
    ...
    \end{tabular}
\end{adjustbox}
\caption{Resultados de los tiempos de ejecución para el Kdd\_cup99 \textit{dataset} en la Raspberry Pi}
...
\centering
    ...
    \end{tabular}
\end{adjustbox}
\caption{Resultados de la precisión de los modelos para el Kdd\_cup99 \textit{dataset} en Raspberry Pi}
...
\centering
    ...
    \end{tabular}
\end{adjustbox}
\caption{Resultados de los tiempos de ejecución para el Kdd\_cup99 \textit{dataset} en el portátil.}
...
\centering
    ...
    \end{tabular}
\end{adjustbox}
\caption{Resultados de la precisión de los modelos para el Kdd\_cup99 \textit{dataset} en el portátil}
\label{tab:acc_Kddpc}
\end{table}
...
\centering
    ...
    \end{tabular}
\end{adjustbox}
\caption{Resultados de los tiempos de ejecución para el \textit{dataset} Sesnores Raspberry Pi en el portátil.}
\label{tab:times_senspc}
\end{table}
