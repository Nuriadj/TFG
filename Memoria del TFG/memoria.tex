...
A continuación se quedará ejecutando indefinidamente un bucle while, que es el que se encarga de guardar los datos sensados cada un segundo. Dicho bucle se puede ver en el Código~\ref{lst:firstloop_read_sensor}. Algo destacable es que para obtener el valor de la luz (proporcionada por el LDR) siempre se le resta a uno el valor sensado. Esto se hace así para que los datos se puedan interpretar mejor, puesto que cuando hay luz a la Raspberry le llega un cero. De esta forma cuando haya luz se guarda un uno en el fichero en vez de un cero. 
...
Para la generación de este dataSet primero estuvo la habitación ocupada durante media hora. Pasada esa media hora la habitación estuvo vacía durante 40 minutos. Después volvió ha estar ocupada durante una hora entera, se vació una última vez durante 25 minutos para estar ocupada los 10 últimos minutos antes de finalizar la recogida de datos.

Sabiendo en qué momentos ha estado ocupada o vacía y observando la Figura~\ref{fig:ejemplo_gráfica} se puede ver que los valores de los datos se diferencian entre el estado ocupado y vacío (a excepción de la presión que no varía), siendo la humedad la variable que más varía sus valores entre ambos estados. La temperatura varía algo menos, pero igualmente se puede ver un pequeño descenso cuando la habitación está vacía. 
...
\centering
    ...
    \cline{4-7}
     ...
     \hline
     Regresión Logísitca & 98.9 & 98.9 & 98.9 & 99.0 & 99.0 & 98.9\\
...
\centering
    ...
    \cline{4-7}
     ...
     SVM & 99.9 & 99.9 & 99.9 & 99.8 & 98.8 & 98.8\\
     Gradient Boosting & 99.9 & 100.0 & 96.2 & 99.2 & 96.5 & 96.5\\
     Random Forest & 100.0 & 100.0 & 96.8 & 96.8 & 98.8 & 98.4\\
    \hline
    \end{tabular}
\end{adjustbox}
...
\centering
    ...
    \cline{4-7}
     ...
     \hline
     Regresión Logísitca & 98.9 & 99.0 & 98.8 & 98.9 & 98.8 & 98.94\\
     SVM & 99.0 & 99.0 & 98.8 & 99.1 & 98.9 & 98.9\\
     Gradient Boosting & 99.0 & 99.3 & 99.1 & 99.0 & 98.7 & 98.9\\
     Random Forest & 99.2 & 100.0 & 99.3 & 99.2 & 99.2 & 99.1\\
    \hline
    \end{tabular}
\end{adjustbox}
...
\centering
    ...
    \cline{4-7}
     &  &   &  Idle & 2 cpu & 4 cpu & 8 cpu \\
     \hline
     Regresión Logísitca & 99.4 & 99.4 & 99.4 & 99.5 & 99.4 & 99.4\\
     SVM & 99.9 & 99.9 & 99.8 & 99.8 & 98.8 & 98.9\\
     Gradient Boosting & 99.9 & 100.0 & 96.2 & 99.2 & 99.4 & 98.4\\
     Random Forest & 100.0 & 100.0 & 98.0 & 96.8 & 96.8 & 97.0\\
    \hline
    \end{tabular}
\end{adjustbox}
...
Tal y como se comentó en el apartado se generó un dataSet mediante los datos proporcionados por los sensores. El dataSet que que se utilizará para estas pruebas se denomina como occup\_detec\_2h\_Clean.csv, en total contiene 9745 líneas de datos que equivalen a unas dos horas y cuarenta minutos de recolección de datos.
